...
def argument_parser():
    ...
    parser.add_argument("--feature-file", nargs="?", default="expression_data.tsv",
                        help="file that contains expression data.")
    ...
    parser.add_argument("--testing-percent", type=int, default=.1,
                        help="Percentage of testing nodes. Default is 10%.")
    parser.add_argument("--validation-percent", type=int, default=.3,
                        help="Percentage of validation nodes. Default is 10%.")
    ...
    parser.add_argument("--attr-emb-dim", type=int, default=128,
                        help="Dimension of feature representation. Default is 128.")
